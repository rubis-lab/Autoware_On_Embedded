...
void LaneDetector::run()
{
    ...
    private_nh.param<std::string>(node_name+"/task_response_time_filename", task_response_time_filename, "~/Documents/profiling/response_time/lane_detector.csv");
...
std::vector<Vec4i> LaneDetector::houghLines(Mat canny, Mat source, bool drawHough)
{
