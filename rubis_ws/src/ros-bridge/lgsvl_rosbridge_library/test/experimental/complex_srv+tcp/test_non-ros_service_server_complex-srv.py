...
from lgsvl_rosbridge_library.util import json
...
service_type = "lgsvl_rosbridge_library/TestNestedService"           # make sure this matches an existing service type on rosbridge-server (in specified srv_module)
