...
from lgsvl_rosbridge_library.internal import services, ros_loader
from lgsvl_rosbridge_library.internal import message_conversion as c
from lgsvl_rosbridge_library.internal.message_conversion import FieldTypeMismatchException
...
class TestServices(unittest.TestCase):
    ...
    def test_populate_request_args(self):
        ...
        for srv_type in ["TestEmpty", "TestResponseOnly"]:
            cls = ros_loader.get_service_class("lgsvl_rosbridge_library/" + srv_type)
            for args in [[], {}, None]:
        ...
        cls = ros_loader.get_service_class("lgsvl_rosbridge_library/TestMultipleRequestFields")
    ...
    def test_service_tester(self):
        t = ServiceTester("/test_service_tester", "lgsvl_rosbridge_library/TestRequestAndResponse")
        t.start()
        time.sleep(1.0)
    ...
    def test_service_tester_alltypes(self):
        ...
        for srv in ["TestResponseOnly", "TestEmpty", "TestRequestAndResponse", "TestRequestOnly",
            ...
            t = ServiceTester("/test_service_tester_alltypes_" + srv, "lgsvl_rosbridge_library/" + srv)
            t.start()
            ts.append(t)
