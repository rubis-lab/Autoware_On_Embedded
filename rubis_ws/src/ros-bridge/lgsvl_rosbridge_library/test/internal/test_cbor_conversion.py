...
import struct
from lgsvl_rosbridge_library.internal.cbor_conversion import extract_cbor_values, TAGGED_ARRAY_FORMATS

try:
    from cbor import Tag
except ImportError:
    from lgsvl_rosbridge_library.util.cbor import Tag
