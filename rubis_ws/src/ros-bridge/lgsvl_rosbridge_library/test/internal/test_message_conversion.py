...
from lgsvl_rosbridge_library.internal import ros_loader
...
class TestMessageConversion(unittest.TestCase):
    ...
    def test_time_msg(self):
        ...
        self.do_test(msg, "lgsvl_rosbridge_library/TestTimeArray")
    ...
    def test_duration_msg(self):
        ...
        self.do_test(msg, "lgsvl_rosbridge_library/TestDurationArray")
    ...
    def test_header_msg(self):
        ...
        msg = {"header": msg}
        self.do_test(msg, "lgsvl_rosbridge_library/TestHeader")
        self.do_test(msg, "lgsvl_rosbridge_library/TestHeaderTwo")

        msg = {"header": [msg["header"], msg["header"], msg["header"]]}
        msg["header"][1]["seq"] = 6
        msg["header"][2]["seq"] = 7
        self.do_test(msg, "lgsvl_rosbridge_library/TestHeaderArray")
    ...
    def test_int8array(self):
        ...
        for msgtype in ["TestChar", "TestUInt8"]:
            rostype = "lgsvl_rosbridge_library/" + msgtype
