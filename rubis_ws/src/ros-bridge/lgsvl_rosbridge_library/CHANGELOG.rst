^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package lgsvl_rosbridge_library
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Python 3 updates/fixes (`#460 <https://github.com/RobotWebTools/rosbridge_suite/issues/460>`_)
  * lgsvl_rosbridge_library, rosbridge_server: Update package format
  Add Python3 conditional dependencies where applicable.
  * lgsvl_rosbridge_library: Fix pngcompression for Python 3
...
* Fix typos in lgsvl_rosbridge_library's description (`#450 <https://github.com/RobotWebTools/rosbridge_suite/issues/450>`_)
...
* fix fragment bug (`#316 <https://github.com/RobotWebTools/rosbridge_suite/issues/316>`_)
  ...
  * fixed travis ci failed by @T045T
  * travis ci failed
  * fix lgsvl_rosbridge_library/test/experimental/fragmentation+srv+tcp test bug
  * sync .travis.yaml
...
* Add Python3 compatibility (`#300 <https://github.com/RobotWebTools/rosbridge_suite/issues/300>`_)
  ...
  * Move definition of string_types to lgsvl_rosbridge_library.util
...
* Update .travis.yml and package.xml for lgsvl_rosbridge_library tests
...
* adding missing dependency in lgsvl_rosbridge_library `#70 <https://github.com/RobotWebTools/rosbridge_suite/issues/70>`_
...
* Update lgsvl_rosbridge_library/package.xml
...
* Moves test package tests into lgsvl_rosbridge_library.
...
* Catkinizing lgsvl_rosbridge_library and server.
...
* Initial commit of lgsvl_rosbridge_library
