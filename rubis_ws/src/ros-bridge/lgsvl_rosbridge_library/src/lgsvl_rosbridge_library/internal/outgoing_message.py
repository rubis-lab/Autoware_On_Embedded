from lgsvl_rosbridge_library.internal.message_conversion import extract_values as extract_json_values
from lgsvl_rosbridge_library.internal.cbor_conversion import extract_cbor_values
from rospy import get_rostime
try:
    from cbor import dumps as encode_cbor
except ImportError:
    from lgsvl_rosbridge_library.util.cbor import dumps as encode_cbor
