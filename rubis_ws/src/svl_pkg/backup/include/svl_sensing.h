...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2, nav_msgs::Odometry> SyncPolicyNoImage;
...
typedef message_filters::Synchronizer<SyncPolicyNoImage> Sync0;
...
private:
    ...
    void callback_no_image(const sensor_msgs::PointCloud2::ConstPtr& lidar_msg, const nav_msgs::Odometry::ConstPtr& odom_msg);
