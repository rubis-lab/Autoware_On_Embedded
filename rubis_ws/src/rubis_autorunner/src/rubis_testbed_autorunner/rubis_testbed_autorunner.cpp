...
void RubisTestbedAutorunner::Run(){
...
void RubisTestbedAutorunner::register_subscribers(){
    ...
    sub_v_[STEP(1)] = nh_.subscribe("/points_raw", 1, &RubisTestbedAutorunner::points_raw_cb, this);   
    sub_v_[STEP(2)] = nh_.subscribe("/ndt_stat", 1, &RubisTestbedAutorunner::ndt_stat_cb, this);   
    sub_v_[STEP(3)] = nh_.subscribe("/detection/object_tracker/objects_center", 1, &RubisTestbedAutorunner::detection_cb, this);   
    sub_v_[STEP(4)] = nh_.subscribe("/behavior_state", 1, &RubisTestbedAutorunner::behavior_state_cb, this);   
}

 void RubisTestbedAutorunner::points_raw_cb(const sensor_msgs::PointCloud2& msg){
...
void RubisTestbedAutorunner::detection_cb(const autoware_msgs::DetectedObjectArray& msg){
 ...
 void RubisTestbedAutorunner::behavior_state_cb(const visualization_msgs::MarkerArray& msg){
