...
(cl:defclass <ColorSet> (roslisp-msg-protocol:ros-message)
  ((Hue
    :reader Hue
    :initarg :Hue
    :type autoware_msgs-msg:ValueSet
    :initform (cl:make-instance 'autoware_msgs-msg:ValueSet))
   (Sat
    :reader Sat
    :initarg :Sat
    :type autoware_msgs-msg:ValueSet
...
(cl:defmethod cl:initialize-instance :after ((m <ColorSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColorSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ColorSet> is deprecated: use autoware_msgs-msg:ColorSet instead.")))

(cl:ensure-generic-function 'Hue-val :lambda-list '(m))
(cl:defmethod Hue-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Hue-val is deprecated.  Use autoware_msgs-msg:Hue instead.")
  (Hue m))

(cl:ensure-generic-function 'Sat-val :lambda-list '(m))
(cl:defmethod Sat-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Sat-val is deprecated.  Use autoware_msgs-msg:Sat instead.")
  (Sat m))

(cl:ensure-generic-function 'Val-val :lambda-list '(m))
(cl:defmethod Val-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Val-val is deprecated.  Use autoware_msgs-msg:Val instead.")
  (Val m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ColorSet>)))
  ...
  (cl:format cl:nil "ValueSet Hue~%ValueSet Sat~%ValueSet Val~%~%================================================================================~%MSG: autoware_msgs/ValueSet~%int32 center~%int32 range~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ColorSet)))
  "Returns full string definition for message of type 'ColorSet"
  (cl:format cl:nil "ValueSet Hue~%ValueSet Sat~%ValueSet Val~%~%================================================================================~%MSG: autoware_msgs/ValueSet~%int32 center~%int32 range~%~%~%"))
