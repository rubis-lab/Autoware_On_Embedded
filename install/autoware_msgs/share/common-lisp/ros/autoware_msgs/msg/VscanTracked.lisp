...
(cl:defclass <VscanTracked> (roslisp-msg-protocol:ros-message)
  ((position
   ...
   (geo_rect
    :reader geo_rect
    :initarg :geo_rect
    :type autoware_msgs-msg:GeometricRectangle
    :initform (cl:make-instance 'autoware_msgs-msg:GeometricRectangle)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VscanTracked>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VscanTracked)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<VscanTracked> is deprecated: use autoware_msgs-msg:VscanTracked instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <VscanTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:position-val is deprecated.  Use autoware_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <VscanTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:orientation-val is deprecated.  Use autoware_msgs-msg:orientation instead.")
  (orientation m))
...
(cl:defmethod geo_rect-val ((m <VscanTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:geo_rect-val is deprecated.  Use autoware_msgs-msg:geo_rect instead.")
  (geo_rect m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VscanTracked>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VscanTracked)))
  "Returns full string definition for message of type 'VscanTracked"
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
