...
(defsystem "autoware_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "IntersectionCondition" :depends-on ("_package_IntersectionCondition"))
    (:file "_package_IntersectionCondition" :depends-on ("_package"))
    ...
    (:file "RUBISTrafficSignal" :depends-on ("_package_RUBISTrafficSignal"))
    (:file "_package_RUBISTrafficSignal" :depends-on ("_package"))
    (:file "RUBISTrafficSignalArray" :depends-on ("_package_RUBISTrafficSignalArray"))
    (:file "_package_RUBISTrafficSignalArray" :depends-on ("_package"))
