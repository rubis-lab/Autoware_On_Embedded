...
(cl:defmethod cl:initialize-instance :after ((m <ValueSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ValueSet> is deprecated: use autoware_msgs-msg:ValueSet instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ValueSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:center-val is deprecated.  Use autoware_msgs-msg:center instead.")
  (center m))
