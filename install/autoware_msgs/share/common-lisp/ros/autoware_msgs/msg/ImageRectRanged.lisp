...
(cl:defclass <ImageRectRanged> (roslisp-msg-protocol:ros-message)
  ((rect
    :reader rect
    :initarg :rect
    :type autoware_msgs-msg:ImageRect
    :initform (cl:make-instance 'autoware_msgs-msg:ImageRect))
   (range
    :reader range
    :initarg :range
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <ImageRectRanged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageRectRanged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ImageRectRanged> is deprecated: use autoware_msgs-msg:ImageRectRanged instead.")))

(cl:ensure-generic-function 'rect-val :lambda-list '(m))
(cl:defmethod rect-val ((m <ImageRectRanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:rect-val is deprecated.  Use autoware_msgs-msg:rect instead.")
  (rect m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ImageRectRanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:range-val is deprecated.  Use autoware_msgs-msg:range instead.")
  (range m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImageRectRanged>)))
  ...
  (cl:format cl:nil "ImageRect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: autoware_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImageRectRanged)))
  "Returns full string definition for message of type 'ImageRectRanged"
  (cl:format cl:nil "ImageRect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: autoware_msgs/ImageRect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
