...
(cl:defmethod cl:initialize-instance :after ((m <ConfigVoxelGridFilter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigVoxelGridFilter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigVoxelGridFilter> is deprecated: use autoware_config_msgs-msg:ConfigVoxelGridFilter instead.")))
