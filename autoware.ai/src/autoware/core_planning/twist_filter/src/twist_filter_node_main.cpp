...
int main(int argc, char** argv)
{
  ...
  #ifdef __aarch64__
  std::string print_file_path("/home/nvidia/Documents/spin_profiling/twist_filter.csv");
  #endif
  #ifndef __aarch64__
  std::string print_file_path("/home/hypark/Documents/spin_profiling/twist_filter.csv");
  #endif
  FILE *fp;
