...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vision_darknet_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bkpark/autoware.ai/src/autoware/core_perception/vision_darknet_detect/${idir}'.  ${_report}")
    endif()
