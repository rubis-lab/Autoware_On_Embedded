...
(cl:defmethod cl:initialize-instance :after ((m <ConfigDistanceFilter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigDistanceFilter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_config_msgs-msg:<ConfigDistanceFilter> is deprecated: use autoware_config_msgs-msg:ConfigDistanceFilter instead.")))

(cl:ensure-generic-function 'sample_num-val :lambda-list '(m))
(cl:defmethod sample_num-val ((m <ConfigDistanceFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_config_msgs-msg:sample_num-val is deprecated.  Use autoware_config_msgs-msg:sample_num instead.")
  (sample_num m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigDistanceFilter>)))
  ...
  "autoware_config_msgs/ConfigDistanceFilter")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigDistanceFilter)))
  "Returns string type for a message object of type 'ConfigDistanceFilter"
  "autoware_config_msgs/ConfigDistanceFilter")
