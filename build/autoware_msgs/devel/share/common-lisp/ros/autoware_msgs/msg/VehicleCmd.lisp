...
(cl:defmethod gear_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:gear_cmd-val is deprecated.  Use autoware_msgs-msg:gear_cmd instead.")
  (gear_cmd m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleCmd>)))
  ...
  "8e7481711780182446911d94fa3a384d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleCmd)))
  "Returns md5sum for a message object of type 'VehicleCmd"
  "8e7481711780182446911d94fa3a384d")
