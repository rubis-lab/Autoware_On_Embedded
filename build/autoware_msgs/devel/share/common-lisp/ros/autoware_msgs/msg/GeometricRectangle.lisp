...
(cl:defmethod cl:initialize-instance :after ((m <GeometricRectangle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeometricRectangle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<GeometricRectangle> is deprecated: use autoware_msgs-msg:GeometricRectangle instead.")))

(cl:ensure-generic-function 'wl-val :lambda-list '(m))
(cl:defmethod wl-val ((m <GeometricRectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:wl-val is deprecated.  Use autoware_msgs-msg:wl instead.")
  (wl m))

(cl:ensure-generic-function 'wr-val :lambda-list '(m))
(cl:defmethod wr-val ((m <GeometricRectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:wr-val is deprecated.  Use autoware_msgs-msg:wr instead.")
  (wr m))

(cl:ensure-generic-function 'lf-val :lambda-list '(m))
(cl:defmethod lf-val ((m <GeometricRectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lf-val is deprecated.  Use autoware_msgs-msg:lf instead.")
  (lf m))

(cl:ensure-generic-function 'lb-val :lambda-list '(m))
(cl:defmethod lb-val ((m <GeometricRectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lb-val is deprecated.  Use autoware_msgs-msg:lb instead.")
  (lb m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeometricRectangle>)))
  ...
  "autoware_msgs/GeometricRectangle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeometricRectangle)))
  "Returns string type for a message object of type 'GeometricRectangle"
  "autoware_msgs/GeometricRectangle")
