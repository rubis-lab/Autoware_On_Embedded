...
(cl:defmethod cl:initialize-instance :after ((m <Gear>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gear)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<Gear> is deprecated: use autoware_msgs-msg:Gear instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Gear>)))
  ...
  (cl:format cl:nil "uint8 NONE=0~%uint8 PARK=1~%uint8 REVERSE=2~%uint8 NEUTRAL=3~%uint8 DRIVE=4~%uint8 LOW=5~%uint8 gear~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Gear)))
  "Returns full string definition for message of type 'Gear"
  (cl:format cl:nil "uint8 NONE=0~%uint8 PARK=1~%uint8 REVERSE=2~%uint8 NEUTRAL=3~%uint8 DRIVE=4~%uint8 LOW=5~%uint8 gear~%~%"))
